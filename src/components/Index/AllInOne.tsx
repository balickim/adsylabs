...
const Title = tw.h1`text-xl tracking-tight text-white text-center lg:text-3xl xl:text-4xl`;
const SubTitle = tw.h3`text-center text-white mx-2 mt-2 lg:w-[600px]`;
